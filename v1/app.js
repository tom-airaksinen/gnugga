...
const KEY = `gnugga-v1arkiv-${LANG.code}-progress`;   // ARKIV: egen nyckel så museikopian inte rör den skarpa appens framsteg
const SETTINGS_KEY = "gnugga-v1arkiv-settings";       // ARKIV: se ovan
